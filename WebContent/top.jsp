...
TH {
	...
	<div>
		<table width="100%" height="90px"  border="0" cellspacing="0" cellpadding="0">
			<tr>
			<div style="background-color:#8AC6CF;width:100%;height:90px;text-align:center;">
				<font color="#ffffff" size="7">个人博客中台系统</font>
				</div>
				<!--  <td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											用户名：	<!-- <span><%=request.getAttribute("login_success")==null?"":request.getAttribute("login_success")%></span>-->
										 <font color="blue">${login_success}</font>
										</td>
